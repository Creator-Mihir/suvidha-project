  ...
  return (
    <div className="max-w-4xl mx-auto w-full">
      ...
      <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-gray-100">
        <h2 className="text-2xl font-black mb-8">📊 Consumption Analytics</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
          <div className="p-8 bg-blue-50 rounded-[2.5rem] border border-blue-100">
            <p className="text-xs font-bold text-blue-400 uppercase mb-2">Current Usage (SCM)</p>
          ...
          <div className="p-8 bg-orange-50 rounded-[2.5rem] border border-orange-100">
            <p className="text-xs font-bold text-orange-400 uppercase mb-2">Previous Month</p>
        ...
        <div className="bg-slate-50 p-6 rounded-3xl">
          <p className="font-bold text-slate-700 mb-2">Efficiency Rating: <span className="text-green-600">Good</span></p>
          <p className="text-sm text-slate-500">Your usage is consistent with residential averages. Ensure burners are cleaned for blue flame efficiency.</p>
        </div>
      </div>
    </div>
  );
