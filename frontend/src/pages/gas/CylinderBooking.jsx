    ...
    <div className="max-w-4xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded-[3rem] shadow-xl border border-gray-100">
          <h3 className="text-xl font-black mb-6">Book Refill</h3>
          {loading ? (
            ...
            <div className="space-y-4">
              ...
              <div className="p-6 bg-orange-50 rounded-2xl border border-orange-100">
                <div className="flex justify-between mb-2">
                  <span className="text-sm font-semibold uppercase text-orange-800">Cylinder Price</span>
                  <span className="font-black">₹903.00</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm font-semibold uppercase text-orange-800">Subsidy Back</span>
