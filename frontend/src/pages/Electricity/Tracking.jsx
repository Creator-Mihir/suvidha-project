  ...
  return (
    <div className="max-w-2xl mx-auto w-full animate-in fade-in duration-500">
      ...
      <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-gray-100">
        <h2 className="text-2xl font-bold mb-6">Live Status Tracker</h2>

        {/* Search input */}
        <div className="flex gap-2 mb-8">
          <input
            type="text"
            placeholder="Enter Ref ID, Ticket ID or App ID"
            value={trackingId}
          ...
          <div className="space-y-6 animate-in slide-in-from-bottom-2">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                trackData.currentStatus === 'resolved'    ? 'bg-green-100 text-green-700' :
